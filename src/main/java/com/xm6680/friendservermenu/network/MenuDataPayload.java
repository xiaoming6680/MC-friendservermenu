...
public record MenuDataPayload(String menuTitle, boolean canUseAdmin, String locationsJson, String activeActivityJson, String tasksJson) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, MenuDataPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.string(32767), MenuDataPayload::tasksJson,
            MenuDataPayload::new
    );
